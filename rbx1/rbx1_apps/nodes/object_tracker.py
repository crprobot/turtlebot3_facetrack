...
class ObjectTracker():
    def __init__(self):
        ...
        #rospy.Subscriber('camera_info', CameraInfo, self.get_camera_info, queue_size=3)
        ...
        rospy.Subscriber('roi', RegionOfInterest, self.set_cmd_vel, queue_size=2)
